  ...
  return (
    <Box sx={{ flexGrow: 2, display: "flex" }}>
      <section className="privacy_policy">
        ...
        <Typography className="privacy_policy__text">Allgemeine Hinweise</Typography>
        ...
        <Typography className="privacy_policy__title">
        ...
        <Typography className="privacy_policy__title" mb={3}>2. Hosting</Typography>
        <Typography className="privacy_policy__text">
          Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
        </Typography>
        <Typography className="privacy_policy__text">Externes Hosting</Typography>
        <Typography className="privacy_policy__text">
        ...
        <Typography className="privacy_policy__text">Datenschutz</Typography>
        <Typography className="privacy_policy__text">
        ...
        <Typography className="privacy_policy__text">Speicherdauer</Typography>
        <Typography className="privacy_policy__text">
        ...
        <Typography className="privacy_policy__text">Server-Log-Dateien</Typography>
        <Typography className="privacy_policy__text">
        ...
        <Typography className="privacy_policy__title">5. Soziale Medien</Typography>
        <Typography className="privacy_policy__text">Social-Media-Elemente</Typography>
        <Typography className="privacy_policy__text">
        ...
        >
          <br />
          <Typography component={"span"} className="privacy_policy__link">
